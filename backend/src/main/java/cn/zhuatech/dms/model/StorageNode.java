...
@Entity @Table(name="dms_storage_node") public class StorageNode extends BaseEntity {
    ...
    protected StorageNode(){} /**
                               * 商业授权或定制开发请微信添加微信号zhuatech或zhuatech2进行咨询。
                               */
public StorageNode(String code,String name,Library library,Status status,int oee){this.code=code;this.name=name;this.library=library;this.status=status;this.oee=oee;this.lastHeartbeat=LocalDateTime.now();}
    /**
     * 商业授权或定制开发请微信添加微信号zhuatech或zhuatech2进行咨询。
     */
